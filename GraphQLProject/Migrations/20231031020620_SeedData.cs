    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John Doe", "johndoe@example.com", 2, "555-123-4567", new DateTime(2023, 11, 6, 23, 6, 20, 879, DateTimeKind.Local).AddTicks(7624), "No nuts in the dishes, please." },
                    { 2, "Jane Smith", "janesmith@example.com", 4, "555-987-6543", new DateTime(2023, 11, 9, 23, 6, 20, 879, DateTimeKind.Local).AddTicks(7640), "Gluten-free options required." },
                    { 3, "Michael Johnson", "michaeljohnson@example.com", 6, "555-789-0123", new DateTime(2023, 11, 13, 23, 6, 20, 879, DateTimeKind.Local).AddTicks(7641), "Celebrating a birthday." }
                });
